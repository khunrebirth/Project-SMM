        ...
        <div class="row justify-content-center">
            <div class="col-xs-12 col-sm-12 col-md-10 col-lg-8">
                ...
                <ul class="nav nav-fill client__navs bg-gray pt-2 pb-2">
                    <li class="nav-item">
                        <a class="nav-link active client__navs--border--right pt-0 pb-0" id="pills-seo-tab" data-toggle="pill" href="#pills-seo" role="tab" aria-controls="pills-seo" aria-selected="true">SEO & SEM</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link client__navs--border--right pt-0 pb-0" id="pills-social-tab" data-toggle="pill" href="#pills-social" role="tab" aria-controls="pills-social" aria-selected="false">Social media</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link client__navs--border--right pt-0 pb-0" id="pills-web-tab" data-toggle="pill" href="#pills-web" role="tab" aria-controls="pills-web" aria-selected="false">พัฒนาเว็บไซต์</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link pt-0 pb-0" id="pills-page-tab" data-toggle="pill" href="#pills-page" role="tab" aria-controls="pills-page" aria-selected="false">Landing Page</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row row-60 row-sm">
            ...
            <div class="col-xs-12 col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay=".1s"
                ...
                <article class="blog blog__modern"><a class="blog__modern--figure"><img src="<?php base_url() ?>resources/front_end/images/example-blog-2.jpg" alt="" width="370" height="307">
                    ...
                    <p class="blog__modern--text">Digital transformation requires cloud appropriate adoption, legacy IT systems modernization, and Agile-based methodologies for faster…
                    </p>
                </article>
            </div>
            <div class="col-xs-12 col-sm-6 col-lg-3 wow fadeInLeft" data-wow-delay=".2s"
                ...
                <article class="blog blog__modern"><a class="blog__modern--figure"><img src="<?php base_url() ?>resources/front_end/images/example-blog-3.jpg" alt="" width="370" height="307">
                    ...
                    <p class="blog__modern--text">In this tutorial, we will discuss the Hibernate Query Language. HQL is an object-oriented query language. Hibernate Query...
                    </p>
                </article>
            </div>
...
<div id="accordion">
    <div class="card text-center" style="background: #00264c; color: #fff; border-radius: 0;">
        <div class="card-header" id="headingOne" style="padding-top: 0px; padding-bottom: 0px;">
            <h5 class="mb-0">
                <button class="btn btn-link" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="color: #fff;">
