	...
	<section class="section">
		<div class="section-header">
			...
			<div class="section-header-breadcrumb">
				...
				<div class="breadcrumb-item"><a href="<?php echo base_url($lang . '/backoffice/page/blogs/list-blogs/' . $category->id); ?>">Blogs (Category: <?php echo unserialize($category->title)['th']; ?>)</a></div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/blogs/list-blogs/update/' . $category->id . '/' . $blog->id); ?>" enctype="multipart/form-data">
								<div class="tab-content">
									...
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview</label>
											<div class="col-sm-10">
												<img id="previewImgEn" style="background-color: #fff;" src="<?php echo base_url('storage/uploads/images/blogs/' . unserialize($blog->img)['en']); ?>" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Image</label>
