				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/blogs/list-blogs/store/' . $category->id); ?>" enctype="multipart/form-data">
								<div class="tab-content">
									<div class="tab-pane active" id="handleTh">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control" name="meta_title_th" placeholder="Meta Title" type="text" value="">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Description</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_description_th" placeholder="Meta Description" type="text" value="">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Keywords</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_keyword_th" placeholder="Meta Keywords" type="text" value="">
											</div>
										</div>
										<!-- OG & Twitter -->
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control" name="title_th" placeholder="Title" type="text" value="">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Description</label>
											<div class="col-sm-10">
												<textarea class="form-control" name="description_section_th"></textarea>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Content</label>
											<div class="col-sm-10">
												<textarea class="summernote" name="body_th"></textarea>
											</div>
										</div>
										<hr>
									</div>
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Description</label>
											<div class="col-sm-10">
												<textarea class="form-control" name="description_section_en"></textarea>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Content</label>
