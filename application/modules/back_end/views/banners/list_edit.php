							...
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/setting/banners/update/' . $banner->id); ?>" enctype="multipart/form-data">
								<div class="tab-content">
									<div class="tab-pane active" id="handleTh">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Upload Image (ขนาดที่แนะนำ 1920*650)</label>
											<div class="col-sm-10">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<img id="previewImgMoblieTh" src="<?php echo base_url('storage/uploads/images/banners/' . unserialize($banner->img_moblie)['th']); ?>" style="background-color: #fff;" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Upload Image(Moblie) (ขนาดที่แนะนำ สูง 500px)</label>
											<div class="col-sm-10">
												<div class="custom-file input-file-w-30">
													<input type="file" name="img_moblie_th" class="custom-file-input" onchange="PreviewImage(this, 'previewImgMoblieTh');">
													<label class="custom-file-label">Choose file (.gif | .jpg | .png)</label>
												</div>
											</div>
										</div>
									...
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview(Moblie)</label>
											<div class="col-sm-10">
												<img id="previewImgMoblieEn" src="<?php echo base_url('storage/uploads/images/banners/' . unserialize($banner->img_moblie)['en']); ?>" style="background-color: #fff;" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Upload Image(Moblie) (ขนาดที่แนะนำ สูง 500px)</label>
											<div class="col-sm-10">
												<div class="custom-file input-file-w-30">
													<input type="file" name="img_moblie_en" class="custom-file-input" onchange="PreviewImage(this, 'previewImgMoblieEn');">
													<label class="custom-file-label">Choose file (.gif | .jpg | .png)</label>
												</div>
											</div>
										</div>
