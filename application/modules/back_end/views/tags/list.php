					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								...
								<a href="<?php echo base_url($lang . '/backoffice/page/blogs/list-tags/create'); ?>" class="btn btn-primary">
									...
									<?php
										...
										foreach ($tags as $tag) { ?>
											<tr>
												...
												<td><?php echo unserialize($tag->title)['en']; ?></td>
												<td><?php echo unserialize($tag->title)['th']; ?></td>
												...
												<td>
													<div class="dropdown d-inline">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item has-icon" href="<?php echo base_url($lang . '/backoffice/page/blogs/list-tags/edit/' . $tag->id); ?>"><i class="far fa-edit"></i> Edit</a>
															<a class="dropdown-item has-icon" onclick="deleteService('<?php echo base_url($lang . '/backoffice/page/blogs/list-tags/destroy/' . $tag->id); ?>')"><i class="far fa-trash-alt"></i> Delete</a>
														</div>
													</div>
												</td>
											</tr>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnSort').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + '/' + window.langSite + '/backoffice/page/blogs/list-tags/ajax/get/tags/sort/show',
                success: function(res) {
        ...
        $('#btnSaveSorting').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + '/' + window.langSite + '/backoffice/page/blogs/list-tags/ajax/get/tags/sort/update',
                data: {
                    id: selectedID,
                    sort: selectedSort
                },
