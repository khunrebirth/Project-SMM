					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								...
								<a href="<?php echo base_url($lang . '/backoffice/page/clients/list-category-clients/create'); ?>" class="btn btn-primary">
									...
									<?php
										...
										foreach ($categories as $category) { ?>
											<tr>
												...
												<td><img src="<?php echo base_url('storage/uploads/images/clients/' . unserialize($category->icon)['en']); ?>" width="40"></td>
												<td><img src="<?php echo base_url('storage/uploads/images/clients/' . unserialize($category->icon)['th']); ?>" width="40"></td>
												<td><?php echo unserialize($category->title)['en']; ?></td>
												<td><?php echo unserialize($category->title)['th']; ?></td>
												<td><?php echo $category->created_at; ?></td>
												<td>
													<a class="btn btn-warning" href="<?php echo base_url($lang . '/backoffice/page/clients/list-clients/' . $category->id); ?>"><i class="far fa-view"></i> Items (<?php echo $category->counter; ?>)</a>
												</td>
												<td>
													<div class="dropdown d-inline">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item has-icon" href="<?php echo base_url($lang . '/backoffice/page/clients/list-category-clients/edit/' . $category->id); ?>"><i class="far fa-edit"></i> Edit</a>
															<a class="dropdown-item has-icon" onclick="deleteCategory('<?php echo base_url($lang . '/backoffice/page/clients/list-category-clients/destroy/' . $category->id); ?>')"><i class="far fa-trash-alt"></i> Delete</a>
														</div>
													</div>
												</td>
											</tr>
...
<script>
    ...
    $(document).ready(function() {
        $('#btnSort').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + '/' + window.langSite +'/backoffice/page/clients/list-category-clients/ajax/get/category-clients/sort/show',
                success: function(res) {
        ...
        $('#btnSaveSorting').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + '/' + window.langSite + '/backoffice/page/clients/list-category-clients/ajax/get/category-clients/sort/update',
                data: {
                    id: selectedID,
                    sort: selectedSort
                },
