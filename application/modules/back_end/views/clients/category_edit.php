				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url('backoffice/page/clients/list-category-clients/update/' . $category->id); ?>" enctype="multipart/form-data">
