				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/home/list-top-portfolios/update/' . $portfolio->id); ?>" enctype="multipart/form-data" id="form-id">
								<br>

								<input type="hidden" id="serviceId" name="service_id" value="<?php echo $portfolio->category_id; ?>">

								<div class="form-group row">
									<label class="col-sm-2 col-form-label text-left text-md-right">บริการ</label>
									<div class="col-sm-10">
										<select class="form-control form-control-sm" id="selectService" name="service" disabled>
											<?php foreach ($services as $service) { ?>
												<option value="<?php echo $service->id; ?>" <?php if ($portfolio->category_id == $service->id) { echo 'selected'; } else { echo ''; } ?>><?php echo unserialize($service->title)['th']; ?> | <?php echo unserialize($service->title)['en']; ?></option>
											<?php } ?>
										</select>
									</div>
								</div>
									...
									<div class="tab-pane active" id="handleTh">
										...
										<div class="wrapperImage">
											...
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input class="form-control input-file-w-30" name="img_title_alt_th" placeholder="Image Title &amp; Alt" type="text" value="<?php echo unserialize($portfolio->title)['th']; ?>">
												</div>
											</div>
										</div>
									...
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="wrapperImage">
											<div class="form-group row">
												<label class="col-sm-2 col-form-label text-left text-md-right">Preview</label>
												<div class="col-sm-10">
													<img id="previewImgEn" style="background-color: #fff;" src="<?php echo base_url('storage/uploads/images/home/' . unserialize($portfolio->image)['en']); ?>" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-2 col-form-label text-left text-md-right"><span class="text-danger">*</span> Image</label>
											...
											<div class="form-group row">
												<label class="col-sm-2 col-form-label text-left text-md-right">Image Title &amp; Alt</label>
												<div class="col-sm-10">
													<input class="form-control input-file-w-30" name="img_title_alt_en" placeholder="Image Title &amp; Alt" type="text" value="<?php echo unserialize($portfolio->title)['en']; ?>">
												</div>
											</div>
										</div>
										<div class="wrapperVideo">
