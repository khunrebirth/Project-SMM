				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/portfolios/list-category-portfolios/update/' . $category->id); ?>" enctype="multipart/form-data">
								<div class="tab-content">
									...
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview(Icon)</label>
											<div class="col-sm-10">
												<img id="previewIconEn" src="<?php echo base_url('storage/uploads/images/portfolios/' . unserialize($category->icon)['en']); ?>" style="background-color: #fff;" width="40px;" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Upload Icon</label>
