											...
											<tr>
												...
												<td>
													<label class="custom-switch p-0">
														<input type="checkbox" name="custom-switch-checkbox" class="custom-switch-input cbToggleIgnore" data-id="<?php echo $portfolio->id; ?>" <?php if ($portfolio->ignore_home == 'Y') { echo 'checked'; } else { echo ''; } ?>>
