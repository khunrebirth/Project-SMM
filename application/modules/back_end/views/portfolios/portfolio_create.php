	...
	<section class="section">
		<div class="section-header">
			...
			<div class="section-header-breadcrumb">
				...
				<div class="breadcrumb-item"><a href="<?php echo base_url($lang . '/backoffice/page/portfolios/list-portfolios/' . $category->id); ?>">Portfolios (Category: <?php echo unserialize($category->title)['th']; ?>)</a></div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/portfolios/list-portfolios/store/' . $category->id); ?>" enctype="multipart/form-data">
...
<!--												<input class="form-check-input" type="checkbox" name="categories[--><?php //echo $portfolio_category->id; ?><!--]" --><?php //if ($portfolio_category->id == $category->id) { echo 'checked'; } ?><!-- >-->
<!--													--><?php //echo unserialize($portfolio_category->title)['th']; ?><!-- <span style="font-size: 11px;">(en: --><?php //echo unserialize($portfolio_category->title)['en']; ?><!--)</span>-->
<!--												</label>-->
<!--											</div>-->
<!--										--><?php //} ?>
<!--									</div>-->
