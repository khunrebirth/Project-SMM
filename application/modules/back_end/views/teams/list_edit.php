				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url('backoffice/page/teams/list-teams/store'); ?>" enctype="multipart/form-data">
								<div class="tab-content">
									<div class="tab-pane active" id="handleTh">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<textarea class="form-control" name="body_th" required></textarea>
											</div>
										</div>
									</div>
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Body</label>
											<div class="col-sm-10">
												<textarea class="form-control" name="body_en" required></textarea>
											</div>
										</div>
									</div>
								</div>
