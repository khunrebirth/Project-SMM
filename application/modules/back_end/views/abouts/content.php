	...
	<section class="section">
		<div class="section-header">
			...
			<div class="section-header-breadcrumb">
				...
				<div class="breadcrumb-item"><a href="#">Page: Abouts</a></div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/abouts/content/update/' . $page_content->id); ?>" enctype="multipart/form-data">
								<div class="tab-content">
									<div class="tab-pane active" id="handleTh">
										...
										<!-- Information -->
										<div style="padding-top: 20px;"><h4><i class="fa fa-tag"></i> Content</h4></div>
										<hr>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Left</label>
											<div class="col-sm-10">
												<textarea class="form-control" name="content_left_th"><?php echo unserialize($page_content->content_left)['th']; ?></textarea>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Right</label>
											<div class="col-sm-10">
												<textarea class="summernote" name="content_right_th"><?php echo unserialize($page_content->content_right)['th']; ?></textarea>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview</label>
											<div class="col-sm-10">
												<img id="previewMetaOgImgTh" src="<?php echo base_url('storage/uploads/images/abouts/' . unserialize($page_content->img_section)['th']); ?>" style="background-color: #fff;" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right"><span class="text-danger">*</span> File Upload</label>
									...
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview</label>
											<div class="col-sm-10">
												<img id="previewImgSectionTh" style="background-color: #fff;" src="<?php echo base_url('storage/uploads/images/about/' . unserialize($page_content->img_og_twitter)['en']); ?>" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right"><span class="text-danger">*</span> File Upload</label>
											<div class="col-sm-10">
												<div class="custom-file input-file-w-30">
													<input type="file" name="img_section_th" class="custom-file-input" onchange="PreviewImage(this, 'previewImgSectionTh');">
													<label class="custom-file-label">Choose file (.gif | .jpg | .png)</label>
												</div>
											</div>
										</div>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Left</label>
											<div class="col-sm-10">
												<textarea class="form-control" name="content_left_en"><?php echo unserialize($page_content->content_left)['en']; ?></textarea>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Right</label>
											<div class="col-sm-10">
												<textarea class="summernote" name="content_right_en"><?php echo unserialize($page_content->content_right)['en']; ?></textarea>
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview</label>
											<div class="col-sm-10">
												<img id="previewImgSectionEn" src="<?php echo base_url('storage/uploads/images/abouts/' . unserialize($page_content->img_section)['en']); ?>" style="background-color: #fff;" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right"><span class="text-danger">*</span> File Upload</label>
											<div class="col-sm-10">
												<div class="custom-file input-file-w-30">
													<input type="file" name="img_section_en" class="custom-file-input" onchange="PreviewImage(this, 'previewImgSectionEn');">
													<label class="custom-file-label">Choose file (.gif | .jpg | .png)</label>
												</div>
											</div>
										</div>
