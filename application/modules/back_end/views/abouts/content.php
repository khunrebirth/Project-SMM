				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url('backoffice/page/abouts/content/update/' . $page_content->id); ?>" enctype="multipart/form-data">
