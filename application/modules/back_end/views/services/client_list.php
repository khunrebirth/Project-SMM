	...
	<section class="section">
		<div class="section-header">
			<div class="section-header-breadcrumb">
				...
				<div class="breadcrumb-item active">Clients (Service: <?php echo unserialize($service->title)['th']; ?>)</div>
			</div>
		</div>
					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								...
								<a href="<?php echo base_url($lang . '/backoffice/page/services/list-service-clients/create/' . $service->id); ?>" class="btn btn-primary">
									...
									<?php
										...
										foreach ($clients as $client) { ?>
											<tr>
												...
												<td><img src="<?php echo base_url('storage/uploads/images/services/' . unserialize($client->img)['en']); ?>" width="120"></td>
												<td><img src="<?php echo base_url('storage/uploads/images/services/' . unserialize($client->img)['th']); ?>" width="120"></td>
												...
												<td>
													<div class="dropdown d-inline">
														...
														<div class="dropdown-menu">
															<a class="dropdown-item has-icon" href="<?php echo base_url($lang . '/backoffice/page/services/list-service-ports/edit/' . $service->id . '/' . $client->id); ?>"><i class="far fa-edit"></i> Edit</a>
															<a class="dropdown-item has-icon" onclick="deleteServiceClient('<?php echo base_url($lang . '/backoffice/page/services/list-service-ports/destroy/' . $client->id); ?>')"><i class="far fa-trash-alt"></i> Delete</a>
														</div>
													</div>
												</td>
											</tr>
...
<script>
    ...
    function deleteServiceClient(url) {
        swal({
            title: 'Are you sure ?',
            icon: 'warning',
            buttons: true,
