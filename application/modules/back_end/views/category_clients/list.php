    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="#">Page: Client</a></div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="<?php echo base_url('backoffice/page/clients/category/create'); ?>" class="btn btn-primary">
                                ...
                                <table class="table table-striped" id="ssmDataTable">
                                    ...
                                    foreach ($clients as $client) { ?>
                                        <tr>
                                            ...
                                            <td><?php echo unserialize($client->title)['en']; ?></td>
                                            <td><?php echo unserialize($client->title)['th']; ?></td>
                                            <td><?php echo $client->created_at; ?></td>
                                            <td><a class="btn btn-warning" href="<?php echo base_url('backoffice/page/project/list-project-pictures/' .  $client->id); ?>"><i class="fas fa-pencil-ruler"></i> Pictures (<?php echo $client->counter; ?>)</a></td>
                                            <td>
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        <a class="dropdown-item has-icon" href="<?php echo base_url('backoffice/page/clients/category/edit/' . $client->id); ?>"><i class="far fa-edit"></i> Edit</a>
                                                        <a class="dropdown-item has-icon" onclick="deleteTeam('<?php echo base_url('backoffice/page/clients/category/edit/' . $client->id); ?>')"><i class="far fa-trash-alt"></i> Delete</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
