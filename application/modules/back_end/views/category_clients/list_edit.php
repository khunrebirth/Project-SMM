    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item"><a href="<?php echo base_url('backoffice/page/clients/category'); ?>">Page: Category Client</a></div>
                <div class="breadcrumb-item active">Edit New</div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs">
                                <li class="nav-item"><a class="nav-link active" data-toggle="tab"
                                                        href="#handleTh">TH</a></li>
                                <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#handleEn">EN</a></li>
                            </ul>
                            <!-- Tab panes -->
                            <form class="form-horizontal" method="post"
                                  action="<?php echo base_url('backoffice/page/clients/category/update/'.$clients->id); ?>"
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane active" id="handleTh">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_th" placeholder="Title"
                                                       type="text" value="<?php echo unserialize($clients->title)['th']; ?>" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="handleEn">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label text-left text-md-right">Title</label>
                                            <div class="col-sm-10">
                                                <input class="form-control" name="title_en" placeholder="Title"
                                                       type="text" value="<?php echo unserialize($clients->title)['en']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
