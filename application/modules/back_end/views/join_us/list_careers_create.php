				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/join-us/list-careers/store'); ?>" enctype="multipart/form-data">
								<div class="tab-content">
									<div class="tab-pane active" id="handleTh">
												...
												<div class="form-group">
													<div class="input-group mb-2">
														<div class="input-group-prepend">
															<div class="input-group-text"><?php echo base_url('th/ร่วมงานกับเรา/'); ?></div>
														</div>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview</label>
											<div class="col-sm-10">
												<img id="previewImgCoverTh" src="" style="background-color: #fff;" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<img id="previewImgCoverMoblieTh" src="" style="background-color: #fff;" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control input-file-w-30" name="img_cover_title_alt_th" placeholder="Image Title &amp; Alt" type="text" value="">
											</div>
										</div>
										<hr>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control" name="comment_th" placeholder="Comment" type="text" value="">
											</div>
										</div>
										<div class="form-group row">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<textarea class="summernote" name="content_th"></textarea>
											</div>
										</div>
										<hr>
									</div>
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<div class="form-group">
													<div class="input-group mb-2">
														<div class="input-group-prepend">
															<div class="input-group-text"><?php echo base_url('en/join-us/'); ?></div>
														</div>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview(moblie)</label>
											<div class="col-sm-10">
												<img id="previewImgCoverMoblieEn" src="" style="background-color: #fff;" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Upload Image Banner(moblie) (ขนาดที่แนะนำ สูง 500px)</label>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Image Title&amp; Alt</label>
											<div class="col-sm-10">
												<input class="form-control input-file-w-30" name="img_cover_title_alt_en" placeholder="Image Title &amp; Alt" type="text" value="">
											</div>
										</div>
										<hr>
										<div class="form-group row">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Comment</label>
											<div class="col-sm-10">
												<input class="form-control" name="comment_en" placeholder="Comment" type="text" value="">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Type</label>
