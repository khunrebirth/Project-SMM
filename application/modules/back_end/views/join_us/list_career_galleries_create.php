				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/join-us/list-career-galleries/store/' . $career->id); ?>" enctype="multipart/form-data">
