	...
	<section class="section">
		<div class="section-header">
			<div class="section-header-breadcrumb">
				...
				<div class="breadcrumb-item active">Careers</div>
			</div>
		</div>
					...
					<div class="card">
						<div class="card-header">
							...
							<div class="card-header-action">
								...
								<a href="<?php echo base_url($lang . '/backoffice/page/join-us/list-careers/create'); ?>" class="btn btn-primary">
...
<script>
    ...
    $(document).ready(function() {
        $('#btnSort').on('click', function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + '/' + window.langSite + '/backoffice/page/join-us/list-careers/ajax/get/careers/sort/show',
                success: function(res) {
        ...
        $('#btnSaveSorting').click(function() {
            ...
            $.ajax({
                type: "POST",
                url: window.base_url + '/' + window.langSite + '/backoffice/page/join-us/list-careers/ajax/get/careers/sort/update',
                data: {
                    id: selectedID,
                    sort: selectedSort
                },
