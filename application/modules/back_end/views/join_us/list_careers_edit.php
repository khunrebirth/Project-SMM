								...
								<div class="tab-content">
									<div class="tab-pane active" id="handleTh">
											...
											<div class="col-sm-10">
												<div class="form-group">
													<div class="input-group mb-2">
														...
														<input class="form-control" name="slug_th" placeholder="Enter URL Slug" type="text" value="<?php echo unserialize($career->slug)['th']; ?>">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_title_th" placeholder="Enter Meta Title" type="text" value="<?php echo unserialize($career->meta_tag_title)['th']; ?>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Description</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_description_th" placeholder="Enter Meta Description" type="text" value="<?php echo unserialize($career->meta_tag_description)['th']; ?>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Keywords</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_keywords_th" placeholder="Enter Meta Keywords" type="text" value="<?php echo unserialize($career->meta_tag_keywords)['th']; ?>">
											</div>
										</div>
										<hr>
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_moblie_title_th" placeholder="Enter Meta Title" type="text" value="<?php echo unserialize($career->meta_tag_moblie_title)['th']; ?>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Description(Moblie)</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_moblie_description_th" placeholder="Enter Meta Description" type="text" value="<?php echo unserialize($career->meta_tag_moblie_description)['th']; ?>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Keywords(Moblie)</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_moblie_keywords_th" placeholder="Enter Meta Keywords" type="text" value="<?php echo unserialize($career->meta_tag_moblie_keywords)['th']; ?>">
											</div>
										</div>
										<!-- OG & Twitter -->
										...
										<hr>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview(moblie)</label>
											<div class="col-sm-10">
												<img id="previewImgCoverMoblieTh" src="<?php echo base_url('storage/uploads/images/join_us/' . unserialize($career->img_cover_moblie)['th']); ?>" style="background-color: #fff;" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<div class="custom-file input-file-w-30">
													<input type="file" name="img_cover_moblie_th" class="custom-file-input" onchange="PreviewImage(this, 'previewImgCoverMoblieTh');">
													<label class="custom-file-label">Choose file (.gif | .jpg | .png)</label>
												</div>
											</div>
										</div>
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control input-file-w-30" name="img_cover_title_alt_th" placeholder="Image Title &amp; Alt" type="text" value="<?php echo unserialize($career->img_cover_title_alt)['th']; ?>">
											</div>
										</div>
										<hr>
										<div class="form-group row">
									...
									<div class="tab-pane fade" id="handleEn">
											...
											<div class="col-sm-10">
												<div class="form-group">
													<div class="input-group mb-2">
														...
														<input class="form-control" name="slug_en" placeholder="Enter URL Slug" type="text" value="<?php echo unserialize($career->slug)['en']; ?>">
													</div>
												</div>
											</div>
										</div>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Title</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_title_en" placeholder="Enter Meta Title" type="text" value="<?php echo unserialize($career->meta_tag_title)['en']; ?>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Description</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_description_en" placeholder="Enter Meta Description" type="text" value="<?php echo unserialize($career->meta_tag_description)['en']; ?>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Keywords</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_keywords_en" placeholder="Enter Meta Keywords" type="text" value="<?php echo unserialize($career->meta_tag_keywords)['en']; ?>">
											</div>
										</div>
										<hr>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Title(Moblie)</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_moblie_title_en" placeholder="Enter Meta Title" type="text" value="<?php echo unserialize($career->meta_tag_moblie_title)['en']; ?>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Description(Moblie)</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_moblie_description_en" placeholder="Enter Meta Description" type="text" value="<?php echo unserialize($career->meta_tag_moblie_description)['en']; ?>">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Meta Keywords(Moblie)</label>
											<div class="col-sm-10">
												<input class="form-control" name="meta_tag_moblie_keywords_en" placeholder="Enter Meta Keywords" type="text" value="<?php echo unserialize($career->meta_tag_moblie_keywords)['en']; ?>">
											</div>
										</div>
										<!-- OG & Twitter -->
										<div style="padding-top: 20px;"><h4><i class="fa fa-tag"></i> Image OG &amp; Twitter</h4></div>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview(moblie)</label>
											<div class="col-sm-10">
												<img id="previewImgCoverMoblieEn" src="<?php echo base_url('storage/uploads/images/join_us/' . unserialize($career->img_cover_moblie)['en']); ?>" style="background-color: #fff;" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Upload Image Banner(moblie) (ขนาดที่แนะนำ สูง 500px)</label>
											<div class="col-sm-10">
												<div class="custom-file input-file-w-30">
													<input type="file" name="img_cover_moblie_en" class="custom-file-input" onchange="PreviewImage(this, 'previewImgCoverMoblieEn');">
													<label class="custom-file-label">Choose file (.gif | .jpg | .png)</label>
												</div>
											</div>
										</div>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Image Title&amp; Alt</label>
											<div class="col-sm-10">
												<input class="form-control input-file-w-30" name="img_cover_title_alt_en" placeholder="Image Title &amp; Alt" type="text" value="<?php echo unserialize($career->img_cover_title_alt)['th']; ?>">
											</div>
										</div>
										<hr>
										<div class="form-group row">
