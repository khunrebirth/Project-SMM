	...
	<section class="section">
		<div class="section-header">
			...
			<div class="section-header-breadcrumb">
				...
				<div class="breadcrumb-item"><a href="<?php echo base_url($lang . '/backoffice/page/join-us/list-career-galleries/' . $career->id); ?>">Gallery (Career: <?php echo unserialize($career->title)['th']; ?>)</a></div>
				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/join-us/list-career-galleries/update/' . $career->id . '/' . $career_gallery->id); ?>" enctype="multipart/form-data">
								<div class="tab-content">
									<div class="tab-pane active" id="handleTh">
										...
										<div class="form-group row">
											...
											<div class="col-sm-10">
												<input class="form-control input-file-w-30" name="img_title_alt_th" placeholder="Image Title &amp; Alt" type="text" value="<?php echo unserialize($career_gallery->img_title_alt)['th']; ?>">
											</div>
										</div>
										<hr>
									</div>
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview</label>
											<div class="col-sm-10">
												<img id="previewImgEn" src="<?php echo base_url('storage/uploads/images/join_us/' . unserialize($career_gallery->img)['en']); ?>" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right"><span class="text-danger">*</span> Image</label>
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Image Title &amp; Alt</label>
											<div class="col-sm-10">
												<input class="form-control input-file-w-30" name="img_title_alt_en" placeholder="Image Title &amp; Alt" type="text" value="<?php echo unserialize($career_gallery->img_title_alt)['en']; ?>">
											</div>
										</div>
										<hr>
									</div>
