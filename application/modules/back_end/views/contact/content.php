				...
				<div class="col-12">
					<div class="card">
						<div class="card-body">
							...
							<!-- Tab panes -->
							<form class="form-horizontal" method="post" action="<?php echo base_url($lang . '/backoffice/page/contact/content/update/' . $page_content->id); ?>" enctype="multipart/form-data">
								<div class="tab-content">
									...
									<div class="tab-pane fade" id="handleEn">
										...
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right">Preview</label>
											<div class="col-sm-10">
												<img id="previewMetaOgImgEn" style="background-color: #fff;" src="<?php echo base_url('storage/uploads/images/contacts/' . unserialize($page_content->img_og_twitter)['en']); ?>" width="18%" onerror="this.onerror=null;this.src='data:image/png;base64,';">
											</div>
										</div>
										<div class="form-group row">
											<label class="col-sm-2 col-form-label text-left text-md-right"><span class="text-danger">*</span> File Upload</label>
