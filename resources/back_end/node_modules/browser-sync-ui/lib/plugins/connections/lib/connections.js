...
/**
 * Track connected category_clients
 * @param {UI} ui
...
/**
 * Use heart-beated data to decorate category_clients
 * @param clients
 * @param clientsInfo
 * @returns {*}
 */
 ...
 * @param data
 */
//function highlightClient (category_clients, data) {
//    var socket = getClientById(category_clients, data.id);
//    if (socket) {
 ...
 * @param id
 */
//function getClientById (category_clients, id) {
//    var match;
//    category_clients.sockets.some(function (item, i) {
//        if (item.id === id) {
//            match = category_clients.sockets[i];
//            return true;
//        }
//    });
//    return match;
